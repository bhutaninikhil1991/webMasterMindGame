...
import com.example.appengine.java8.Peg.*;
...
public class MasterMindServlet extends HttpServlet {
    ...
    private Color getPegColor(String color) {
        ...
        if (color.equals("rgb(255, 0, 0)"))
            temp = "Red";
        else if (color.equals("rgb(0, 128, 0)"))
            temp = "Green";
        else if (color.equals("rgb(0, 0, 255)"))
            temp = "Blue";
        else if (color.equals("rgb(255, 255, 0)"))
            temp = "Yellow";
        else if (color.equals("rgb(128, 0, 128)"))
            temp = "Purple";
        else if (color.equals("rgb(255, 165, 0)"))
            temp = "Orange";
        else if (color.equals("rgb(128, 128, 128)"))
            temp = "Gray";
        else if (color.equals("rgb(255, 255, 255)"))
            temp = "White";

        return Color.valueOf(temp.toUpperCase().trim());
    }
